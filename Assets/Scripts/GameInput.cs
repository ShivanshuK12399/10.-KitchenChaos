...
public class GameInput : MonoBehaviour {
    ...
    #region Mobile Input
    public void Interact() { OnInteractAction?.Invoke(this, EventArgs.Empty); }
    public void AlternateInteract() { OnInteractAlternateAction?.Invoke(this, EventArgs.Empty); }
    public void Pause() { OnPauseAction?.Invoke(this, EventArgs.Empty); }
    #endregion
